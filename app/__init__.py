...
def umar():
    return render_template('about-me.html', title="Umar Ahmer", url=os.getenv("URL"),
        ...
        bio="Hey! I am a second year computer science student at McMaster University. "
        ...
        work_experiences=[
            {"title": "Conference Team Lead", "company": "Google Developer Groups", "date": "2024-present"},
